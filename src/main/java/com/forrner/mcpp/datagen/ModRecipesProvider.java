        ...
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                ...
                SimpleCookingRecipeBuilder.blasting(
                        ...
                        .save(recipeOutput, getBlastingRecipeName(ModItems.DIAMOND_NUGGET));
                ...
                SimpleCookingRecipeBuilder.blasting(
                        ...
                        .save(recipeOutput, getBlastingRecipeName(Items.DIAMOND));
            ...
            public void suspiciousStew(final Item item) {
                ...
                if (effectHolder != null) {
                    ...
                    shapeless(RecipeCategory.FOOD, stew)
                            .requires(Items.BOWL)
                            ...
                            .save(recipeOutput, getItemName(stew.item().value()) + "_from_" + getItemName(item));
                }
            }
